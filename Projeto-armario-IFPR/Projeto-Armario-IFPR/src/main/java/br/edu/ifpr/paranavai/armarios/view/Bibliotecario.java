...
public class Bibliotecario extends javax.swing.JFrame {
    ...
    private void AcessarButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AcessarButtonMouseClicked
        ...
        String resposta = controle.loginVerificacaoArmario(email, senha, null, false);
        if(resposta.equals("Usuário logado!")) {
