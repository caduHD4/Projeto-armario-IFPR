...
import br.edu.ifpr.paranavai.controller.EstudanteController;
 ...
 * @author Aluno
 */
public class EstudanteList extends javax.swing.JFrame {

    private List<Estudante> listaEstudante;
    
    public EstudanteList() {
        initComponents();
        this.listaEstudante = EstudanteController.listarEstudantes();
        fillTable(this.listaEstudante);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for(int i = 0; i < this.listaEstudante.size(); i++) {
            if(this.listaEstudante.get(i).getRa().contains(txtFiltro.getText())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EstudanteList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EstudanteList().setVisible(true);
            }
        });
    }
    ...
    private void fillTable(List<Estudante> listaEstudante) {
