...
import br.edu.ifpr.paranavai.controller.ArmarioController;
 ...
 * @author Aluno
 */
public class ArmarioList extends javax.swing.JFrame {

    private List<Armario> listaArmario;
    
    public ArmarioList() {
        initComponents();
        this.listaArmario = ArmarioController.listarArmarios();
        fillTable(this.listaArmario);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for(int i = 0; i < this.listaArmario.size(); i++) {
            if(this.listaArmario.get(i).getObservacoes().contains(txtFiltro.getText())) {
                listaAtualizada.add(this.listaArmario.get(i));
            }
        }
        this.fillTable(listaAtualizada);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArmarioList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ArmarioList().setVisible(true);
            }
        });
    }
    ...
    private void fillTable(List<Armario> listaArmario) {
        ...
        for (Armario armario : listaArmario) {
            ...
            dadosLinha[1] = armario.getObservacoes();
